...
import { joinRoom, leaveRoom, createTransportForPeer, handleProduce, getRoomPeers } from "./roomManager";
import { logger } from "./logger";

/**
 * PeerSocket
 * - We add .id and .room to the WebSocket so we know who the socket belongs to.
 */
type PeerSocket = WebSocket & { id?: string; room?: string };
